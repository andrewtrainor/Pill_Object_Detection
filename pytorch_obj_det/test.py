...
dataset = RaccoonDataset(root='../Pill_Object_Detection', 
                        data_file = "../Pill_Object_Detection/all_labels.csv",
                        transforms = get_transform(train=True))

dataset_test = RaccoonDataset(root='../Pill_Object_Detection', 
                        data_file = "../Pill_Object_Detection/all_labels.csv",
...
os.mkdir("~/repos/pytorch_obj_det/Pillcount/")
torch.save(model.state_dict(), "~/repos/pytorch_obj_det/Pillcount/model")
#"""